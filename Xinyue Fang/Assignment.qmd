...
**Change in Viewership (Season-over-Season)**

viewership \<- viewership %\>% arrange(Season) %\>% mutate(Change = Viewers - lag(Viewers))

ggplot(viewership, aes(x = Season, y = Change)) + geom_col(fill = "#3498db") + labs( title = "Season-over-Season Change in Viewership", x = "Season", y = "Change in Viewership (Millions)" ) + geom_hline(yintercept = 0, linetype = "dashed", color = "gray50")
